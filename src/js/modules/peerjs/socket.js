...
var Socket = (function (_super) {
    ...
    Socket.prototype._sendQueuedMessages = function () {
        ...
        var copiedQueue = util.__spread(this._messagesQueue);
        this._messagesQueue = [];
        try {
            for (var copiedQueue_1 = util.__values(copiedQueue), copiedQueue_1_1 = copiedQueue_1.next(); !copiedQueue_1_1.done; copiedQueue_1_1 = copiedQueue_1.next()) {
